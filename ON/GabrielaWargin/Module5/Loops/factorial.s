...
for_loop:   
            bgt		$t1, $t0, exit	# if $t1 > $t0 is true, jump to exit
...
exit:
            ...
            move 	$a0, $t0		# copy t0 value into a0 to be printed
            syscall

            li		$v0, 4		    # print string
            la		$a0, r		    # print r address to a0 to access and print the string
            syscall
