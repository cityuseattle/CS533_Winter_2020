...
main:
        ...
        la      $a0, num            # address of "please enter a number" string
        syscall
...
while:
        ...
        bnez    $t2, else           # check the condition t2!=0, if true, it jump to else. otherwise continue the code
        ...
        mflo    $t0                 # update the value of t0, t0=t0/t1, same as n=n/1
...
end_while:
        li      $v0, 1              # print integer
        move    $a0, $t0            # same as printing 'n' at the end of teh c++ code
        syscall
