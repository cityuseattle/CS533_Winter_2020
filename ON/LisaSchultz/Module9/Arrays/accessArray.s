...
main:
        ...
        sw		$t1, ($t0)		# first array element set to 3; indirect address

        li		$t1, 5		    # $t1 = 5
        sw      $t1, 4($t0)     # second array element set to 5

        li		$t1, 6		    # $t1 = 6
        sw      $t1, 8($t0)     # second array element set to 5

        li		$t1, 8		    # $t1 = 8
        sw      $t1, 12($t0)    # second array element set to 5

        li		$t1, 10		    # $t1 = 10
        sw      $t1, 16($t0)    # second array element set to 5
